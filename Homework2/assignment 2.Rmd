...
Analysis of Variance (ANOVA) was employed to evaluate the influence of demographic variables on scientific literacy. The variables included respondents' sex, age, race, marital status, number of children, educational level, sexual orientation, income and home ownership. Significant findings were further explored using Post Hoc tests.
