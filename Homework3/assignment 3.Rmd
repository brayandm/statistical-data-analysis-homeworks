...
lm_model1 <- lm(price ~ . - diamond_classificationmedium - diamond_classificationlarge, data = data)
```
...
lm_model1 <- lm(price_transformed_lm1 ~ . - diamond_classificationmedium - diamond_classificationlarge - price,
                data = data)
```
