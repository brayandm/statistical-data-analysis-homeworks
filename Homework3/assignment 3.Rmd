...
```{r, fig.width=10, fig.height=10}
mse_model1 <- mean(residuals(lm_model1)^2)
rmse_model1 <- sqrt(mse_model1)
mae_model1 <- mean(abs(residuals(lm_model1)))
mse_model2 <- mean(residuals(lm_model2)^2)
rmse_model2 <- sqrt(mse_model2)
mae_model2 <- mean(abs(residuals(lm_model2)))
